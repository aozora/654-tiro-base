...
<Dialog open={isOpen} on:close={() => (isOpen = false)} class='cb-modal-wrapper'>
  <DialogOverlay class='cb-modal-overlay' />
  ...
  <div class='cb-modal'>
    <div class='cb-modal-content'>
      ...
      <button type='button' class='cb-modal-close' on:click={() => (isOpen = false)}>
        <Close size={20} />
      </button>
